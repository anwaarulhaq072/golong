                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name = "userid"  value = "<?php if(isset($_GET['userid'])) echo $_GET['userid']; else echo $userid;?>"/>
                                <?php else: ?>
                                    ...
                                    <div class="card-body" style="padding: 3.5rem 2.5rem;">
                                        ...
                                        <table class="table_cla">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: end;"><?php if(isset($start_date) && isset($end_date)) $start_date =  date('j M Y', strtotime($start_date)); $end_date =  date('j M Y', strtotime($end_date)); echo $start_date." to ".$end_date ; ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo '<hr style="color: black;height: 3px;margin-top: 5px;margin-bottom: 5px;">'; ?></td>
                                                <td><?php echo '<hr style="color: black;height: 3px;margin-top: 5px;margin-bottom: 5px;">'; ?></td>
                                        ...
                                        <!--    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.golongclients.com<br><br>-->
                                            Note:  Have you checked your statement today? Should you have any questions on fees or see an error please contact your account representative on the details above. Please make sure any outstanding fees or charges are pail prior to your next withdrawal. </p>
                                            <div class="row">
                                        <div class="mb-2 col-md-3 check_s csname" >
                                        TRANSACTION DETAIL
                                        </div>
                                    ...
                                    <table id="" class="table toggle-circle mb-0" data-page-size="<?php echo sizeof($all_Data); ?>">
                                        <thead style="background-color: #F2F2F2;">
                                            ...
                                            <tbody>
                                                ...
                                                <?php if($i == 0): ?>
                                                <tr> 
                                                    <td><?php if(isset($start_date)) $date = explode(" ",$start_date); echo date('m/d/y',strtotime($start_date)); ?></td>
                                                ...
                                                <tr> 
                                                    ...
                                                    <td><?php if(isset($all_Data[$i]['payout'])): echo '$'.number_format($all_Data[$i]['payout']); elseif(isset($all_Data[$i]['widthra'])): echo '$'.number_format($all_Data[$i]['widthra']); elseif(isset($all_Data[$i]['deposit'])): echo '$'.number_format($all_Data[$i]['deposit']); elseif(isset($all_Data[$i]['trasition'])): if (isset($all_Data[$i]['type']) && $all_Data[$i]['type'] == 'Profit'): echo '$'.number_format($all_Data[$i]['trasition']); elseif(isset($all_Data[$i]['type']) && $all_Data[$i]['type'] == 'Loss'): echo '-$'.number_format($all_Data[$i]['trasition']); endif; endif;?></td>
