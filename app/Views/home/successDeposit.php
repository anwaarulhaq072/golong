...
<head>
    <meta charset="utf-8" />
    <title>Success Deposit - <?php echo APP_NAME ?></title>
                ...
                <div class="mt-5">
                    <div class="card ribbon-box">
                        <div class="card-body">
                            ...
                            <h5 class="text-success float-start mt-0">Deposit Received</h5>
                            <div class="ribbon-content">
                                <p class="mb-0">We have received your Deposit request. You will receive funds in your account within 24 hours.</p>
                                <div class="text-center mt-5 mb-3">
                                    <a href="<?php echo base_url(); ?>"><button class="btn btn-primary px-5" style=" background-color: #0073B6; ">Dashboard</button></a>
                                    <a href="<?php echo base_url(); ?>/user/deposit"><button class="btn btn-info px-5" style="border: 1px solid #000000; background-color: #000000; ">View all Deposits</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
